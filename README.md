...
## FrontEnd:
* [css3 frameworks review](https://colorlib.com/wp/free-css3-frameworks/)
* [materializecss](http://materializecss.com/getting-started.html)
* [js templates review](https://developer.mozilla.org/en/docs/JavaScript_templates)
* [js templates mustache](https://github.com/janl/mustache.js)
* [js templates handlebars](https://github.com/wycats/handlebars.js)
* https://vuejs.org/


## Help manuals:
* [add .ppk keys on windows](/docs/0-manuals/ppk-keys-on-windows.md)
* [PHP7 with mongodb on composer](/docs/0-manuals/php7-mongodb-composer.md)
* [migrate to Symfony3](/docs/0-manuals/sf3-migration.md)
* [Ubuntu+nginx+php7+mongo](/docs/0-manuals/ubuntu-nginx-php7-mongo.md)
* [MongoDB create user for DB](/docs/0-manuals/mongodb-create-user.md)
* [MongoDB backup](/docs/0-manuals/mongodb-backup-restore.md)
* [Memcache on Windows](/docs/0-manuals/memcache-windows.md)
* [Imagick for Ubuntu](/docs/0-manuals/imagick-ubuntu.md)
* [Nginx http autorization](https://www.digitalocean.com/community/tutorials/how-to-set-up-http-authentication-with-nginx-on-ubuntu-12-10﻿)
